...
def compare(user_score, computer_score):
    ...
    if user_score == computer_score:
        ...
        return "You have the lower score. You lose ☹️"
...
def play_game():
    ...
    # Create a while loop that will be active until the game is OverflowError
    ...
    #Also account for blackjack score of 0.
    while computer_score != 0 and computer_score < 17:
        computer_cards.append(deal_card())
        computer_score = calculate_score(computer_cards)

    # Use the compare() function here because both the user and computer are done drawing cards.
    print("Game over!")
